  ...
  return (
   ...
   <Container bg="gray.100" p="20px"  mt="80px" W={{base:"100%",md:"80%",lg:"60%"}} >
    ...
    <Text  w="500px" padding="20px" ligneHeigth="40px"  marginTop="5px" color="gray.600" fontSize="18px " >
      ...
      J' ai obtenu mon diplôme dans la spécialité "montage vidéo graphique". J'ai débuté dans la profession et j'ai beaucoup évolué depuis.
      J'ai appris à maîtriser les outils de design graphique et montage vidéo, des années plus tard, j'ai décidé de se lancer 
